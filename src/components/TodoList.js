        ...
        return (
            <div className="card">
                <div className="row">
                    ...
                    <div className="dated col-sm-12">
                        <div className="date col-sm-3">
                            {today.getDate()}
                        </div>
                        <div className="monthyear col-sm-3" >
                            <div className="row">{month}</div>
                            <div className="row">{today.getFullYear()}</div>
                        </div>
                            <div className="day col-sm-6">{day}</div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className="card-body">
                        <button className="btn btn-warning" onClick={() => this.addItem(document.getElementById('save1').value)}>Add</button>
                    </div>
